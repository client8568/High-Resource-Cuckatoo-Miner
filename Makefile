...
# GPU trimming rounds
GPU_TRIMMING_ROUNDS = 28

# CPU trimming rounds
CPU_TRIMMING_ROUNDS = 300
...
GPU_TRIMMING_PERFORM_FINE_BUCKET_SORTING_IN_TWO_STEPS = false
...
GPU_TRIM_EDGES_IN_STEPS_ROUND_ONE_STEP_ONE_KERNEL_NUMBER_OF_WORK_ITEMS_PER_WORK_GROUP = 512
...
GPU_TRIM_EDGES_IN_STEPS_ROUND_TWO_STEP_ONE_KERNEL_NUMBER_OF_WORK_ITEMS_PER_WORK_GROUP = 512

# GPU trim edges in steps round two step two kernel number of work items per work group
GPU_TRIM_EDGES_IN_STEPS_ROUND_TWO_STEP_TWO_KERNEL_NUMBER_OF_WORK_ITEMS_PER_WORK_GROUP = 512
...
MAX_NUMBER_OF_CPU_CORES_USED = UINT_MAX
...
STRATUM_SERVER_MAX_NUMBER_OF_UNRELATED_MESSAGES_ALLOWED = 5
