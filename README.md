...
* Mac Studio M1 Ultra (64 GB unified memory, 48 GPU cores) performing cuckatoo31 targeting fast speed (≈2.31 g/s and ≈79.221W of power per graph):
```
...
* Mac Studio M1 Ultra (64 GB unified memory, 48 GPU cores) performing cuckatoo31 targeting power efficiency (≈1.64 g/s and ≈67.073W of power per graph):
```
...
* Mac Studio M1 Ultra (64 GB unified memory, 48 GPU cores) performing cuckatoo32 targeting fast speed (≈1.01 g/s and ≈190.099W of power per graph):
```
...
* Mac Studio M1 Ultra (64 GB unified memory, 48 GPU cores) performing cuckatoo32 targeting power efficiency (≈0.86 g/s and ≈154.651W of power per graph):
```
